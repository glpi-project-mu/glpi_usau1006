...
class PassiveDCEquipment extends CommonDBTM
{
   ...
   // From CommonDBTM
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('passivedcequipmenttypes_id', $input) && $input['passivedcequipmenttypes_id'] != 0 && PassiveDCEquipmentType::getById($input['passivedcequipmenttypes_id']) == false){
            array_push($selector_ids_incorrect,'passivedcequipmenttypes_id');
        }
        ...
        else if(array_key_exists('passivedcequipmentmodels_id', $input) && $input['passivedcequipmentmodels_id'] != 0 && PassiveDCEquipmentModel::getById($input['passivedcequipmentmodels_id']) == false){
            array_push($selector_ids_incorrect,'passivedcequipmentmodels_id');
        }
        else if(array_key_exists('id', $input) && $input['id'] != 0 && PassiveDCEquipment::getById($input['id']) == false){
            array_push($selector_ids_incorrect,'passivedcequipment_id');
        }
