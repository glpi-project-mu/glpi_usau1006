...
class Printer extends CommonDBTM
{
    ...
    */
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('printertypes_id', $input) && $input['printertypes_id'] != 0 && PrinterType::getById($input['printertypes_id']) == false){
        ...
        else if(array_key_exists('printermodels_id', $input) && $input['printermodels_id'] != 0 && PrinterModel::getById($input['printermodels_id']) == false){
            array_push($selector_ids_incorrect,'printermodels_id');
        }
        else if(array_key_exists('snmpcredentials_id', $input) && $input['snmpcredentials_id'] != 0 && SNMPCredential::getById($input['snmpcredentials_id']) == false){
        ...
        else if(array_key_exists('networks_id', $input) && $input['networks_id'] != 0 && Network::getById($input['networks_id']) == false){
        ...
        else if(array_key_exists('id', $input) && $input['id'] != 0 && Printer::getById($input['id']) == false){
            array_push($selector_ids_incorrect,'printer_id');
        }
