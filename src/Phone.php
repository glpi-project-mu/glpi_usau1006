...
class Phone extends CommonDBTM
{
    ...
    */
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('phonetypes_id', $input) && $input['phonetypes_id'] != 0 && PhoneType::getById($input['phonetypes_id']) == false){
        ...
        else if(array_key_exists('phonemodels_id', $input) && $input['phonemodels_id'] != 0 && PhoneModel::getById($input['phonemodels_id']) == false){
        ...
        else if(array_key_exists('phonepowersupplies_id', $input) && $input['phonepowersupplies_id'] != 0 && PhonePowerSupply::getById($input['phonepowersupplies_id']) == false){
