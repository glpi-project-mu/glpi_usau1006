...
class CartridgeItem extends CommonDBTM
{
   ...
   ///// SPECIFIC FUNCTIONS
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('cartridgeitemtypes_id', $input) && $input['cartridgeitemtypes_id'] != 0 && CartridgeItemType::getById($input['cartridgeitemtypes_id']) == false){
        ...
        else if(array_key_exists('id', $input) && $input['id'] != 0 && CartridgeItem::getById($input['id']) == false){
