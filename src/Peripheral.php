...
class Peripheral extends CommonDBTM
{
    ...
    */
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('peripheraltypes_id', $input) && $input['peripheraltypes_id'] != 0 && PeripheralType::getById($input['networkequipmenttypes_id']) == false){
        ...
        else if(array_key_exists('peripheralmodels_id', $input) && $input['peripheralmodels_id'] != 0 && PeripheralModel::getById($input['peripheralmodels_id']) == false){
        ...
        else if(array_key_exists('id', $input) && $input['id'] != 0 && Peripheral::getById($input['id']) == false){
            array_push($selector_ids_incorrect,'peripheral_id');
        }
