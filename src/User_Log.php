 ...
 * Log Class
 **/
class User_Log extends CommonDBTM
{
    ...
    public static function showForItem(CommonDBTM $item, $withtemplate = 0)
    {
       ...
       // Total Number of events
        ...
        TemplateRenderer::getInstance()->display('components/logs.html.twig', [
            ...
            ? User_Log::getDistinctUserNamesValuesInItemLog($item)
            : [],
            'affected_fields'   => $is_filtered
            ? User_Log::getDistinctAffectedFieldValuesInItemLog($item)
            : [],
            'linked_actions'    => $is_filtered
            ? User_Log::getDistinctLinkedActionValuesInItemLog($item)
            : [],
