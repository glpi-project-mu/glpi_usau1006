...
class NetworkEquipment extends CommonDBTM
{
   ...
   // From CommonDBTM
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('networkequipmenttypes_id', $input) && $input['networkequipmenttypes_id'] != 0 && NetworkEquipmentType::getById($input['networkequipmenttypes_id']) == false){
        ...
        else if(array_key_exists('networkequipmentmodels_id', $input) && $input['networkequipmentmodels_id'] != 0 && NetworkEquipmentModel::getById($input['networkequipmentmodels_id']) == false){
        ...
        else if(array_key_exists('id', $input) && $input['id'] != 0 && NetworkEquipment::getById($input['id']) == false){
            array_push($selector_ids_incorrect,'networkequipment_id');
        }
