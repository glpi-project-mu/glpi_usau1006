...
class Document extends CommonDBTM
{
   ...
   // From CommonDBTM
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('documentcategories_id',$input) && $input['documentcategories_id'] != 0 && DocumentCategory::getById($input['documentcategories_id']) == false){
            array_push($selector_ids_incorrect,'documentcategories_id');
        }
        else if(array_key_exists('id',$input) && $input['id'] != 0 && Document::getById($input['id']) == false){
            array_push($selector_ids_incorrect,'document_id');
        }
