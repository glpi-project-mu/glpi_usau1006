...
class Computer extends CommonDBTM
{
   ...
   ///Device container - format $device = array(ID,"device type","ID in device table","specificity value")
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('computertypes_id', $input) && $input['computertypes_id'] != 0 && ComputerType::getById($input['computertypes_id']) == false){
        ...
        else if(array_key_exists('computermodels_id', $input) && $input['computermodels_id'] != 0 && ComputerModel::getById($input['computermodels_id']) == false){
        ...
        else if(array_key_exists('id', $input) && $input['id'] != 0 && Computer::getById($input['id']) == false){
            array_push($selector_ids_incorrect,'computer_id');
        }
