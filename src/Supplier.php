...
class Supplier extends CommonDBTM
{
   ...
   // From CommonDBTM
    ...
    public function checkAppliedBusinessRules(array &$input):bool{
        ...
        else if(array_key_exists('suppliertypes_id',$input) && $input['suppliertypes_id'] != 0 && SupplierType::getById($input['suppliertypes_id']) == false){
            array_push($selector_ids_incorrect,'suppliertypes_id');
        }
        else if(array_key_exists('id',$input) && $input['id'] != 0 && Supplier::getById($input['id']) == false){
